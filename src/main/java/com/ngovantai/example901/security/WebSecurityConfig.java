package com.ngovantai.example901.security;
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers(HttpMethod.POST, "/api/promotions/**")
                                                .hasAuthority("ROLE_ADMIN")
                                                .requestMatchers(HttpMethod.PUT, "/api/promotions/**")
                                                .hasAuthority("ROLE_ADMIN")
                                                .requestMatchers(HttpMethod.DELETE, "/api/promotions/**")
                                                .hasAuthority("ROLE_ADMIN")

                                                // ========== PROMOTION PRODUCTS (WRITE - ADMIN only) ==========
                                                .requestMatchers(HttpMethod.POST, "/api/promotion-products/**")
                                                .hasAuthority("ROLE_ADMIN")
                                                .requestMatchers(HttpMethod.PUT, "/api/promotion-products/**")
                                                .hasAuthority("ROLE_ADMIN")
                                                .requestMatchers(HttpMethod.DELETE, "/api/promotion-products/**")
                                                .hasAuthority("ROLE_ADMIN")
